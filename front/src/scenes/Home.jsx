  ...
  const commands = {
    ...
    rules: {
      action: () => [
        ...
        <TerminalOutput key="5">{'- the goal of the game is to be on the winning team by ant means necessary'}</TerminalOutput>,
        ...
        <TerminalOutput key="15">{'    - every round the bottom half of players by votes are “redacted” (eliminated)'}</TerminalOutput>,
      ],
